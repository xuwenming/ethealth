...
@Entity
@Table(name = "fd_medicine_practice")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TfdMedicinePractice implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "FdMedicinePractice";
	...
	//columns END
		...
		public TfdMedicinePractice(){
		}
		public TfdMedicinePractice(Integer id) {
			this.id = id;
		}
	...
	public boolean equals(Object obj) {
		if(obj instanceof FdMedicinePractice == false) return false;
		if(this == obj) return true;
		FdMedicinePractice other = (FdMedicinePractice)obj;
