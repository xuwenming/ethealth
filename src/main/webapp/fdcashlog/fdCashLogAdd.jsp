...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdCashLogController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input class="span2" name="handleTime" type="text" onclick="WdatePicker({dateFmt:'<%=TfdCashLog.FORMAT_HANDLE_TIME%>'})"  maxlength="0" class="" />
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="bankPhone" type="text"/>
					</td>							
					<th><%=TfdCashLog.ALIAS_BANK_ID_NO%></th>	
					<td>
											<input class="span2" name="bankIdNo" type="text"/>
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
											<input class="span2" name="alipay" type="text"/>
					</td>							
				</tr>	
			</table>		
		</form>
