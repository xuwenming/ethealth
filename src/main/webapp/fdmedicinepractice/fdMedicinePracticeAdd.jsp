...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdMedicinePracticeController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											<input class="span2" name="view" type="text"/>
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
											<input class="span2" name="isUp" type="text"/>
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
											<input class="span2" name="desc" type="text"/>
					</td>							
				</tr>	
				<tr>	
