...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdMemberDoctorShController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input class="span2" name="createTime" type="text" onclick="WdatePicker({dateFmt:'<%=TfdMemberDoctorSh.FORMAT_CREATE_TIME%>'})"  maxlength="0" class="" />
					</td>							
				...
				<tr>	
					...
					<td>
					<input class="span2" name="updateTime" type="text" onclick="WdatePicker({dateFmt:'<%=TfdMemberDoctorSh.FORMAT_UPDATE_TIME%>'})"  maxlength="0" class="" />
					</td>							
