...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdBalanceLogController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											<input class="span2" name="adminId" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="balanceNo" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
											...
											<input  name="amountLog" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
					<th><%=TfdBalanceLog.ALIAS_NOTE%></th>	
					<td>
											<input class="span2" name="note" type="text"/>
					</td>							
				</tr>	
				<tr>	
