...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdFileController/add',
			onSubmit : function() {
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											...
											<input  name="savename" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
				</tr>	
				<tr>	
					...
					<td>
											...
											<input  name="savepath" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
					<th><%=TfdFile.ALIAS_EXT%></th>	
					<td>
					
											<input  name="ext" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
				</tr>	
				<tr>	
					...
					<td>
											...
											<input  name="mime" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
					<th><%=TfdFile.ALIAS_SIZE%></th>	
					<td>
					
											<input  name="size" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
											...
											<input  name="location" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
