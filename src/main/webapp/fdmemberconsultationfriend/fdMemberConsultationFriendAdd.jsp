...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdMemberConsultationFriendController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input class="span2" name="lastTime" type="text" onclick="WdatePicker({dateFmt:'<%=TfdMemberConsultationFriend.FORMAT_LAST_TIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
