...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/fdMemberConsultationExpireController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input class="span2" name="expireDate" type="text" onclick="WdatePicker({dateFmt:'<%=TfdMemberConsultationExpire.FORMAT_EXPIRE_DATE%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
